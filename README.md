...
Additionally, if you encounter any trouble using the above method, or just wanting to use the module without installing it, you can just clone it and put it in the same directory as your project.
